...
class OpenAIInstance(ModelInstance):
...
class DeepSeekInstance(ModelInstance):
    """Represents an instance of a DeepSeek model that tracks a conversation."""
    def __init__(self, model_name: str, system_prompt: str):
        self.model_name = model_name
        self.messages = [{"role": "system", "content": system_prompt}]
        self.client = OpenAI(api_key=os.environ["NEBIUS_API_KEY"], base_url="https://api.studio.nebius.ai/v1")
